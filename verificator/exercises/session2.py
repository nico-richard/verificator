...
CAS_EXERCICES = [('s2-convertir-c-en-k',
  ...
  [('valeur positive', (20,), 293.15),
   ...
   ('précision sans arrondi', (12.345678,), 285.495678),
   ('température négative', (-40,), 233.15)]),
 ('s2-convertir-depuis-m',
  ...
  [('unité par défaut', (2.56,), 2.6),
   ...
   ('zéro', (0, 'cm'), 0),
   ('centimètres arrondis vers le bas', (0.01234, 'cm'), 1.2),
   ('kilomètres arrondis vers le bas', (1234, 'km'), 1.2)]),
 ('s2-deplacer',
 ...
 ('s2-moyenne',
  ...
  [('série simple', ([10, 12, 14],), 12.0),
   ...
   ('arrondi vers le bas', ([1, 1, 2],), 1.33),
   ('arrondi négatif', ([-1, -2, -2],), -1.67),
   ('zéros et signes mélangés', ([-3, 0, 3],), 0.0)]),
 ('s2-analyser-phrase',
  ...
  [('deux mots', ('alpha beta',), ('a', 'alpha', ' beta', ['alpha', 'beta'])),
   ...
   ('espaces uniquement', ('   ',), (' ', '   ', '   ', [])),
   ('un caractère', ('Z',), ('Z', 'Z', 'Z', ['Z'])),
   ('cinq caractères', ('abcde',), ('a', 'abcde', 'abcde', ['abcde']))]),
 ('s2-generer-mesures',
  ...
  [('croissante', (10, 3, 4), [10, 13, 16, 19]),
   ...
   ('départ négatif', (-5, 2, 6), [-5, -3, -1, 1, 3, 5]),
   ('cent valeurs', (0, 1, 100), list(range(100)))]),
 ('s2-maximum',
  ...
  [('milieu', ([3, 1, 8, 2],), 8),
   ...
   ('fin', ([1, 2, 9],), 9),
   ('doublons', ([4, 4, 2],), 4),
   ('décimaux', ([1.2, 1.9, 1.5],), 1.9),
   ('décimaux négatifs', ([-0.8, -0.2, -0.5],), -0.2),
   ('maximum nul', ([-2, 0, -1],), 0)]),
 ('s2-nettoyer-noms',
  ...
  [('nettoyage', ('  Alice ; ; Bob ;Charlie  ',), ['Alice', 'Bob', 'Charlie']),
   ...
   ('casse et ordre conservés', (' zOE ; alice ; BOB ; zOE ',),
    ['zOE', 'alice', 'BOB', 'zOE']),
   ('espaces intérieurs conservés', (' Jean  Paul ; Anne   Marie ',),
    ['Jean  Paul', 'Anne   Marie'])]),
 ('s2-atteindre-objectif',
  ...
  [('dépassement', (10, 7, 30), (3, 31)),
   ...
   ('objectif nul', (0, 1, 0), (0, 0)),
   ('gain unitaire', (2, 1, 7), (5, 7))]),
 ('s2-premiere-mesure-superieure',
  ...
  [('première alerte', ([-2, 5, 4, 7, 9], 5), 3),
   ...
   ('début', ([8, 9], 5), 0),
   ('fin', ([-1, 2, 9], 5), 2),
   ('décimaux et égalité au seuil', ([-0.1, 0.2, 0.3, 0.9], 0.2), 2),
   ('zéro égal au seuil', ([0, 0, 1], 0), 2)])]
